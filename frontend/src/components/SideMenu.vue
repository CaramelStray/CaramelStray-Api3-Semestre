<template>
  <aside class="sidebar">
    ...
    <nav class="sidebar__nav">
      <router-link :to="{ name: 'LiderInicio' }" class="nav-item" :class="{ active: $route.name === 'LiderInicio' }">
      ...
      <router-link :to="{ name: 'LiderFuncionarios' }" class="nav-item" :class="{ active: $route.name === 'LiderFuncionarios' || $route.name === 'LiderLista' || $route.name === 'LiderVerPerfil' }">
      ...
      <router-link :to="{ name: 'LiderAvaliacoes' }" class="nav-item" :class="{ active: $route.name === 'LiderAvaliacoes' || $route.name === 'LiderStatusAvaliacoes' || $route.name === 'LiderVerRespostas' || $route.name === 'LiderTeste' }">
...
const logout = () => { console.log("Sair SideMenu"); };
</script>
