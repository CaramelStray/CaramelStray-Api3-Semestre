  ...
  <aside class="sidebar">
    <div class="sidebar__header">
      ...
      <div class="sidebar__text">
        ...
        <div class="sidebar__subtitle">Supervisão</div>
      </div>
    </div>
    ...
    <nav class="sidebar__nav">
      <router-link :to="{ name: 'SupervisorInicio' }" class="nav-item" active-class="active">
        <svg viewBox="0 0 24 24" width="20" height="20">
      ...
      <router-link :to="{ name: 'SupervisorFuncionarios' }" class="nav-item" active-class="active">
        <svg viewBox="0 0 24 24" width="20" height="20">
      ...
      <router-link
        v-if="usuarioLogado"
        :to="{ name: 'SupervisorVerCompetencias', params: { id: usuarioLogado.codigo } }"
        class="nav-item"
        active-class="active"
      >
      ...
      <router-link :to="{ name: 'SupervisorAvaliacoes' }" class="nav-item" active-class="active">
        <svg viewBox="0 0 24 24" width="20" height="20">
