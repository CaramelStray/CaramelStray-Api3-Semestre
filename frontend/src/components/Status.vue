      ...
      <div class="avaliacoes-container">
        ...
        <article v-for="a in avaliacoes" :key="a.id" class="card item">
          <header class="item__header">
            ...
            <button class="btn btn--primary btn--start" @click="iniciar(a)">Iniciar</button>
          </header>
...
function iniciar(a){ console.log('Iniciar avaliação', a.id) }
...
.btn{height:36px;padding:0 12px;border:1px solid #e6effa;background:#fff;border-radius:10px;cursor:pointer;color:#1f2d3d;}
